                        ...
                        <div class="col-md-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="type" id="type" class="form-control">
                                    <option value="post" {{ old('position', $post->type) == "post" ? 'selected' : '' }}>Bài viết</option>
                                    <option value="page" {{ old('position', $post->type) == "page" ? 'selected' : '' }}>Trang đơn</option>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option value="2" {{ old('position', $post->status) == "2" ? 'selected' : '' }}>Chưa xuất bản</option>
                                    <option value="1" {{ old('position', $post->status) == "1" ? 'selected' : '' }}>Xuất bản</option>
                                </select>
                            </div>
                        </div>
                    </div>
