                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ old('name', $user->username) }}" name="username" id="username" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <input type="password" value="{{ old('name', $user->name) }}" name="password_re" id="password_re"
                                    class="form-control">
                            </div> --}}
                            <div class="mb-3">
